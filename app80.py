...
def predict(stock):
    ...
    model_path = os.path.join(MODEL_DIR, f"{stock}_gru_model_lr5_2.h5")
    ...
    layout = go.Layout(
        title={
            'text': f'Harga Saham {stock} - Historis dan Prediksi 6 Bulan ke Depan (Januari - Juni) 2025 (80/20 Epochs 100)',
            'x': 0.5,
            'xanchor': 'center'
        },
        autosize=True,
